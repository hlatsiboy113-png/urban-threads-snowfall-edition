...
export async function fetchProducts(options = {}) {
  ...
  try {
    ...
    // Only cache non-empty full-catalogue results
    if (!category && !limitCount && products.length > 0) {
